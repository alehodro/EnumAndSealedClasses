...
константах. Это очень похоже на имплементацию интерфейсов с той разницой, что все функции зашиты в тело enum класса.
...
/*
Возможно определить статичную функцию для Enum класса через companion object
 */

enum class LanguagesWithCompanionObject(val country:String) {
    RUSSIAN("Russia"),
    ENGLISH("USA,England,Australia") ,
    ITALIAN("Italy");
    companion object{
        fun getCountryByLanguage(language:String)= LanguagesWithCompanionObject.valueOf(language.toUpperCase())
    }
}
